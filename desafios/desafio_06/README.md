...
#### [OK] 3. 🚦 FormRequest de Validação (`StorePostRequest`)
...
#### [OK] 4. 🛡️ Mass Assignment no Model `Post`
...
#### [OK] 6. 🔗 Divergência de Route Model Binding (`routes/api.php`)
...
#### [OK] 7. 🎁 Transformação de Dados via API Resource (`PostResource`)
...
#### [OK] 8. 🔐 Permissões e Autorização (`PostPolicy`)
...
#### [OK] 9. 📢 Registro de Observers (`PostObserver`)
...
#### [OK] 10. ⚡ Despacho de Queued Job (`ProcessPostSlugJob`)
